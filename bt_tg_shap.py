...
# Output paths
shap_output_path = "/net/mraid20/export/genie/LabData/Analyses/tomerse/diet_mb/SHAP_plots/phenotypes_predictions/thesis"
...
for target in predict_subset:
    ...
    plt.savefig(f"{plot_path_base}_new.png", dpi=300, facecolor="white", bbox_inches='tight')
